...
import { api, getComputerServerOrigin, getInternalComputerOrigin, getPairingServerOrigin, getServerOrigin, type ApiProject, type ApiQuotaSnapshot, type ApiQuotaWindow } from '@/api/client'
